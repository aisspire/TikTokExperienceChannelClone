...
在开发本项目前，我并没有急于编码，而是先思考了该功能在短视频生态中的产品价值。
...
3. **用户体验差异化**：本项目完美复刻了这种“逛”的体验，在有限的移动端屏幕上实现了视觉美感与信息效率的平衡。
...
| :--------------------------------------------: | :--------------------------------------------: | :---------------------------------------------: |
| <img src="screenshot_double.jpg" width="200"/> | <img src="screenshot_single.jpg" width="200"/> | <img src="screenshot_refresh.gif" width="200"/> |
